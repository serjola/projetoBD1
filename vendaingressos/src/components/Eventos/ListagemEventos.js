...
import ModalEditaEvento from '../uteis/ModalEditaEvento';
...
const TitlePane = styled.div`
    ...
    display:inline-block;
`;
const DescricaoPane = styled.div`
    font-size: 0.8rem;
    text-align: center;
    vertical-align: middle;
    width:20%;
...
function ListagemEventos(props){

    const handleSubmit = () => {
        var xhr = new XMLHttpRequest();
        xhr.open("DELETE", `http://localhost:4002/evento/delete/${id}`, true);
